...
![КАРТИНКА](project/lab_2/Домашняя_работа_3_подключенный_диск.jpg)
...
### 3.2 Создал раздел:
![КАРТИНКА](project/lab_2/Домашняя_работа_3_создал_раздел.jpg)

### 3.3 Отформатировал диск и смонтировал раздел:
![КАРТИНКА](project/lab_2/Домашняя_работа_3_отформатировал_диск_и_ссмонтировал_раздел.jpg)
...
![КАРТИНКА](project/lab_2/Домашняя_работа_3_проверка_целеостности_данных.jpg)
