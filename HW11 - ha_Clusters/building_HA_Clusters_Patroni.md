...
- Разверните два кластера в разных зонах доступности или регионах одного облака.
- В первом — полноценный Patroni HA кластер
- Во втором — Standby кластер
- Настройте репликацию и отказоустойчивый DNS(например, с Keepalived или сторонним балансировщиком)
- Проверьте отказ одного из кластеров и переключение трафика
...
# 5. Репликация. Настройте репликацию
...
# 6. HAproxy. Настройте балансировщик
